...
The number of function evaluations (NFE) required per sample is reported alongside each result. For flow-based methods, NFE is determined by the number of neural-network evaluations during numerical integration; for one-step methods, NFE is ideally one.
