...
\begin{figure}[t]
  ...
  \caption{One-step samples from AlphaFlow on ImageNet (illustrative; replace with actual AlphaFlow outputs) \citep{zhang2025alphaflow}.}
...
\begin{itemize}
    ...
    \item We analyze three key methodological advances---consistency flow matching, mean flows, and AlphaFlow---comparing their training requirements, theoretical guarantees, and empirical performance.
