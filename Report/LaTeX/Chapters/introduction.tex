...
\begin{itemize}
    ...
    \item We analyze four key methodological advances---consistency flow matching, shortcut models, mean flows, and AlphaFlow---comparing their training requirements, theoretical guarantees, and empirical performance.
